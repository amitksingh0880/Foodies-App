import {
  ...
  useIsPresent,
  usePresence
} from "./chunk-N3AR3FBO.js";
import {
  createPopper
} from "./chunk-JLPWFL5A.js";
import {
  require_react_dom
} from "./chunk-VOIIMNUF.js";
import {
  require_jsx_runtime
...
function useCounter(props = {}) {
  ...
  const reset = (0, import_react60.useCallback)(() => {
    ...
    if (defaultValue == null) {
      ...
      next2 = (_a8 = cast2(defaultValue, stepProp, precisionProp)) != null ? _a8 : min;
    }
    update(next2);
...
var restoreFocusTo = function(location) {
  ...
  for (var _i = 0, stack_1 = stack; _i < stack_1.length; _i++) {
    ...
    if (parent_1 && ownerDocument.contains(parent_1)) {
      var left = (_b5 = line2.left) === null || _b5 === void 0 ? void 0 : _b5.call(line2);
...
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react74.useRef)(fn);
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react108.useRef)(null);
  const popper = (0, import_react108.useRef)(null);
